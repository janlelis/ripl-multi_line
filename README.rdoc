...
== Extending MultiLine
To use your own multi-line detection engine, read the source at <tt>lib/ripl/multi_line.rb</tt>, set <tt>Ripl.config[:multi_line_ruby]</tt> to <tt>false</tt> and overwrite <tt>Shell#multiline?</tt> with your version.
